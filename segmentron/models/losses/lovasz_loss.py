"""Lovasz-Softmax and Jaccard hinge loss in PyTorch Maxim Berman 2018 ESAT-PSI
KU Leuven (MIT License) https://github.com/bermanmaxim/LovaszSoftmax/blob/maste
r/pytorch/lovasz_losses.py."""
...
class LovaszSoftmax(nn.Module):
    ...
    def forward(self,
        ...
        if self.class_weight is not None:
            ...
            class_weight = None
        loss_cls = self.loss_weight * lovasz_softmax(
            F.softmax(cls_score, dim=1), label, ignore=self.ignore_index)
        return loss_cls
